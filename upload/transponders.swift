...
//
// script to generate list of transponder ids
//
// swift transponders.swift > transponders.txt
//

func isValidTransponder(_ num: Int) -> Bool {
    let n1 = num & 0b111
    let n2 = (num>>3) & 0b111
    let n3 = (num>>6) & 0b111
    let n4 = (num>>9) & 0b111
...
let results = (0..<4096).filter(isValidTransponder(_:))
var cnt = 1
results.forEach {
