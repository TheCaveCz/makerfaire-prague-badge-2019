...
//
// Handles transponder dumping - transmitting all IDs of other badges we've seen
//
...
void logicDumpRespond(IrCommand& c) {
  // id1 must contain our ID
  if (c.fields.id1 != storageMyId && c.fields.id1 != STORAGE_WILDCARD_ID) {
